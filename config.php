        ...
        'leaders' => [
            'items' => [
                [
                    ...
                    'image_pos' => 'top',
                    'link_url'  => 'https://www.liifund.org/justgoodcapital/2023/02/21/annual-letter-from-our-ceo-and-board-chair',
                ...
                [
                    ...
                    'link_url'  => 'https://www.liifund.org/justgoodcapital/2023/02/21/the-continued-advancement-of-our-impact-risk-profitability-irp-framework-and-toolkit',
                    'image_pos' => 'bottom',
                ...
                [
                    ...
                    'image_pos' => 'bottom',
                    'link_url'  => 'https://www.liifund.org/justgoodcapital/2023/02/21/redefining-equity-moving-beyond-what-to-how',
                    'link_text' => 'Read the full statement',
                ],
            ],
        ],
        ...
        'articles' => [
            'items' => [
                [
                    ...
                    'color'   => 'blue',
                    'image'         => '/assets/images/article-bg-mom-baby.png',
                    ...
                    'excerpt_pos'   => 'right',
                    'link_url'      => 'https://www.liifund.org/justgoodcapital/2023/02/21/impact-led-lending-liifs-new-irp-framework-redefines-risk-centers-equity',
                    'link_text'     => 'Read more',
                    'spotlight'     => '',
                ],
                [
                    ...
                    'image_pos'     => '',
                    'excerpt'       => 'LIIF has a longstanding history of innovative capital deployment that supports the expansion of the housing supply. While we have invested over $xx that’s produced over xx units, we continued to grapple with a persistent housing crisis that significantly burdened Black, Latino and other comm-unities of color. As we embarked on our strategic planning journey, we recognized producing units was not enough. We needed a strategy that addressed the systemic racism that encouraged the dismantling of Black and Latino communities. In order to make true impact we needed to create and leverage strategic partnerships.',
                    'excerpt_pos'   => 'right',
                    'link_url'      => 'https://www.liifund.org/justgoodcapital/2023/02/21/affordable-housing-solid-partnerships-and-a-foundation-of-liifs-work',
                    'link_text'     => 'Read more',
                    'spotlight'     => '<strong>SPOTLIGHT:</strong> Frederick Samuels Apartments<br/><em>New York City</em><br/>Showcasing LIIF’s continued commitment to the preservation of affordable housing is the renovation of Harlem’s Frederick Samuels Apartments. This is an existing cluster of 664 affordable units to be preserved via the PACT program, New York City’s version of HUD’s Rental Assistance Demonstration (RAD) program. Genesis Companies and Lemor Development Group are using $1 million each from their LIIF Black Capital Developer Initiative (BDCI) financing to meet an anticipated 2025 completion date. This development exemplifies LIIF’s belief that healthy communities start with stable, quality affordable housing and early care and education: A co-located childcare center will be rehabbed, as will small business spaces and a community center serving local families.',
                ],
                [
            ...
            'items' => [
                ...
                [
                    ...
                    'items' => [
                        ...
                        'Los Angeles County Metropolitan Transporation Authority (MTA)',
                        'Local Initiatives Support Corporation (LISC)',
                        'Los Angeles County Development Authority, Community Development Commission',
                        ...
                        'Purpose Built Communities (via grant from the Truist Foundation)',
                        'redefinED atlanta',
                        'Robert Wood Johnson Foundation',
                ...
                [
                    ...
                    'items' => [
                        ...
                        [
                            'name' => 'Margaret Anadu',
                            'title' => 'Global Head of Sustainability and Impact for Asset Management, Goldman Sachs',
                        ],
                        [
                            'name' => 'Derek Douglas',
                            'title' => 'Vice President for Civic Engagement and External Affairs, University of Chicago',
                        ],
                        [
                            'name' => 'David Fleming, MD',
                            'title' => 'Distinguished Fellow, Trust for America’s Health',
                        ],
                        [
                            'name' => 'Donna Gambrell',
                            'title' => 'President & CEO, Appalachian Community Capital;  Former Director, CDFI Fund',
                        ],
                        [
                            'name' => 'Calvin Gladney',
                        ...
                        [
                            ...
                            'title' => 'Founding President, Stewards of Affordable Housing for the Future',
                        ],
                        [
                            'name' => 'Dionne Nelson',
                ...
                [
                    ...
                    'items' => [
                        [
                            ...
                            'items' => [
                                [
                                    'name' => 'William Kelly, Jr. (Chair)',
                                    'title' => 'Stewards of Affordable Housing for the Future',
                                ],
                                [
                                    'name' => 'Russell Bruemmer',
                                    'title' => '(formerly) Wilmer Cutler, Pickering, Hale and Dorr',
                                ],
                                [
                                    'name' => 'Donna Gambrell',
                                    'title' => 'Appalachian Community Capital',
                                ],
                                [
                                    'name' => 'Calvin Gladney',
                                ...
                                [
                                    'name' => 'Michael A. Solomon',
                                    'title' => 'Charles Schwab Bank & Trust Services',
                                ],
                                [
                                    'name' => 'Daniel A. Nissenbaum',
                                    'title' => 'LIIF (alternate)',
                                ],
                            ],
                        ],
                        [
                            'name' => 'New Markets Tax Credit Advisory Board',
                            'items' => [
                                [
                                    'name' => 'Mikki Anderson',
                                    'title' => 'Purpose Built Communities',
                                ],
                                [
                                    'name' => 'Althea Arnold',
                                    'title' => 'Stewards of Affordable Housing for the Future',
                                ...
                                [
                                    'name' => 'Thomas Yu',
                                    'title' => 'Asian Americans for Equality',
                                ],
                            ],
                        ],
                        [
                            'name' => 'Eastern Region Advisory Committee',
                            'items' => [
                                [
                                    'name' => 'David Beer',
                                ...
                                [
                                    'name' => 'Becky Koch',
                                    'title' => 'HSBC Bank USA, N.A.',
                                ],
                                [
                                    'name' => 'Lesley Palmer',
                                    'title' => 'Mizuho Bank USA',
                                ],
                                [
                                    'name' => 'Mariadele Priest',
                                    'title' => 'Capital One',
                                ],
                                [
                                    'name' => 'Rebecca Regan',
                                    'title' => 'Terra Search Partners',
                                ],
                                [
                                    'name' => 'Kristen Scheyder',
                                    'title' => 'Citi Foundation',
                                ],
                                [
                                    'name' => 'Joan Tally',
                        ...
                        [
                            'name' => 'Western Region Advisory Committee',
                            'items' => [
                                [
                                    'name' => 'Allison Brooks',
                                    'title' => 'Bay Area Regional Collaborative',
                                ],
                                [
                                    'name' => 'Maria Bustria-Glickman',
                                    'title' => 'U.S. Bank Community Development Corporation',
                                ],
                                [
                                    'name' => 'David Erickson',
                                ...
                                [
                                    'name' => 'Richard Mandel',
                                    'title' => 'California Housing Partnership Corporation',
                                ],
                                [
                                    'name' => 'Adam Miller',
                                    'title' => 'Swing Left',
                                ...
                                [
                                    'name' => 'Debbie Ruane',
                                    'title' => 'Norwood Development Strategies',
                                ],
                                [
                                    'name' => 'Doug Shoemaker',
                        ...
                        [
                            'name' => 'San Francisco Child Care Facilities Fund Program Advisory Committee',
                            'items' => [
                                [
                                    'name' => 'Fonda Davidson',
                                    'title' => 'Cross Cultural Family Center',
                                ],
                                [
                                    'name' => 'Maria del Rosario Villasana',
                                ...
                                [
                                    'name' => 'Graham Dobson',
                                    'title' => 'San Francisco Office of Early Care and Education',
                                ],
                                [
                                    'name' => 'Dannhae Herrera Wilson',
                                    'title' => 'Mission Economic Development Agency',
                                ],
                                [
                                    'name' => 'Anne Kwong',
                                    'title' => 'Chinatown Community Children’s Center',
                                ],
                                [
                                    'name' => 'Lawland Long',
                                    'title' => 'FACES SF',
                                ...
                                [
                                    'name' => 'Mona Malan',
                                    'title' => 'Children’s Council of San Francisco',
                                ],
                                [
                                    'name' => 'Christina Marchiel',
                                    'title' => 'Mission Kids Co-Op',
                                ],
                                [
                                    'name' => 'Michael Neumann',
                                    'title' => 'Wu Yee Children’s Services',
                                ],
                                [
                                    'name' => 'Mario Paz',
                                    'title' => 'Good Samaritan Family Resource Center, Inc.',
                                ],
                                [
                                    'name' => 'Corey Santillan',
                                    'title' => 'La Bamba Preschool Family Child Care Home',
                                ],
                                [
                                    'name' => 'Yohanna Quiroz',
                                    'title' => 'Felton Institute',
                                ],
                                [
                                    'name' => 'Oscar Tang',
                                    'title' => 'Family Child Care Assocation of SF & CA Family Child Care Network',
                                ],
                                [
                                    'name' => 'Mark Tao',
                                    'title' => 'Wu Yee Children’s Services',
                ...
                [
                    ...
                    'items' => [
                        ...
                        [
                            'name' => 'Amir Ali',
                            'title' => 'Deputy Director, Southeast',
                        ],
                        [
                            'name' => 'Lucy Arellano Baglieri',
                            'title' => 'Chief Strategy Officer & EVP',
                        ],
                        [
                            'name' => 'Javier Argudo',
                        ...
                        [
                            'name' => 'Emma Chávez',
                            'title' => 'Market Director, Western Region',
                        ],
                        [
                            'name' => 'Kim DiGiacomo',
                            'title' => 'National Program Director, Early Care and Education',
                        ],
                        [
                            'name' => 'Art Fatum',
                        ...
                        [
                            'name' => 'Sondra Ford',
                            'title' => 'Director, SPARCC Initiative',
                        ],
                        [
                            'name' => 'Eliisa Frazier',
                            'title' => 'Director, Racial Equity & Impact Lending',
                        ],
                        [
                            'name' => 'Angie Garling',
                            'title' => 'Vice President, Early Care & Education',
                        ],
                        [
                            'name' => 'Samantha Hojo',
                            'title' => 'Director, Strategic Communications & Influence',
                        ],
                        [
                            'name' => 'Roxanne Huey',
                        ...
                        [
                            'name' => 'Charlie Hutton',
                            'title' => 'Director, Portfolio Accounting',
                        ],
                        [
                            'name' => 'Susan Hyman',
                        ...
                        [
                            'name' => 'Alexis Iwanisziw',
                            'title' => 'Chief of Staff',
                        ],
                        [
                            'name' => 'Laura Jackman',
                            'title' => 'Deputy Director, Early Care & Education',
                        ],
                        [
                            'name' => 'Celeste Krishna',
                            'title' => 'Director, Loan Administration & Asset Management',
                        ],
                        [
                            'name' => 'LaToya Kyle',
                            'title' => 'Market Director, Southeast Region',
                        ],
                        [
                            'name' => 'Kimberly Latimer-Nelligan',
                            'title' => 'President',
                        ...
                        [
                            'name' => 'Kevin McVey',
                            'title' => 'Deputy Director, New Markets Tax Credits',
                        ],
                        [
                            'name' => 'Mario Moreno',
                        ...
                        [
                            'name' => 'Maygen Moore',
                            'title' => 'Director, National Lending Initiatives',
                        ],
                        [
                            'name' => 'Daniel A. Nissenbaum',
                            'title' => 'CEO',
                        ...
                        [
                            'name' => 'Galina Parastaeva',
                            'title' => 'Director of Compliance',
                        ],
                        [
                            'name' => 'Kenny Rodgers',
                            'title' => 'Deputy Market Director, Coachella Valley',
                        ],
                        [
                            'name' => 'Kirsten Shaw',
                            'title' => 'Vice President, Northeast & Mid-Atlantic Regions',
                        ],
                        [
                            'name' => 'Surat Sinha',
                        ...
                        [
                            ...
                            'title' => 'Vice President, Development & Impact Investing',
                        ],
                        [
                            'name' => 'Ken Stewart',
                            'title' => 'Deputy Director, Mid-Atlantic Region',
                        ],
                        [
                        ...
                        [
                            'name' => 'Victoria Whittaker',
                            'title' => 'Director, National Programs',
                        ],
                    ],
                ],
            ],
