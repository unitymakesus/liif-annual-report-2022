...
window.addEventListener('DOMContentLoaded', function () {
  ...
  if (!(0,_util_prefersReducedMotion__WEBPACK_IMPORTED_MODULE_5__["default"])()) {
    ...
    var animateEls = document.querySelectorAll('.progress-bar__overlay, .hero__subtitles, .green-rule, .green-rule__hero, .green-rule__article, .green-rule__tabs, .green-rule__tabs-alt, .progress, .card__body, .card__note');
