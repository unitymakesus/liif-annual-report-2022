...
<article class="impact-article max-w-7xl mx-auto px-6 sm:px-8 sm:py-16 mt-8 green-rule__article">
  <h2 class="text-{{ $article->color }} text-center font-extrabold text-4xl md:text-5xl mb-8 sm:w-[80%] mx-auto relative pl-6 md:pl-16 lg:pl-12 xl:pl-0">{{ $article->title }}</h2>
