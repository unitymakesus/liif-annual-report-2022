...
window.addEventListener('DOMContentLoaded', () => {
  ...
  if (tableYears.length) {
    ...
    if (!prefersReducedMotion()) {
      ...
      const animateEls = document.querySelectorAll('.progress-bar__overlay, .hero__subtitles, .green-rule, .green-rule__hero, .green-rule__article, .green-rule__tabs, .green-rule__tabs-alt, .progress, .card__body, .card__note');
